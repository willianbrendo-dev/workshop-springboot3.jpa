...
public class TestConfig implements CommandLineRunner{
	...
	public void run(String... args) throws Exception {
		...
		Order o1 = new Order(null, Instant.parse("2025-09-24T13:45:30Z"), u2);
		Order o2 = new Order(null, Instant.parse("2023-12-31T23:59:59Z"), u1);
		Order o3 = new Order(null, Instant.parse("2024-07-15T08:20:10Z"), u2);
